          ...
          <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <Link to="/home">
              {ktThemeModeValue === "light" ? (
                <img alt="Logo" src={toAbsoluteUrl("media/logos/honeycomb_light.png")} className="h-50px h-lg-30px app-sidebar-logo-default" />
              ) : (
                <img alt="Logo" src={toAbsoluteUrl("media/logos/honeycomb_dark.png")} className="h-50px h-lg-30px app-sidebar-logo-default" />
                // <>
                //   <img alt="Logo" src={toAbsoluteUrl("media/logos/favicon.png")} className="h-20px h-lg-30px app-sidebar-logo-default theme-light-show" />
                //   <img alt="Logo" src={toAbsoluteUrl("media/logos/honeycomb_light.png")} className="h-50px h-lg-30px app-sidebar-logo-default theme-dark-show" />
                // </>
              )}
            </Link>
          </div>
