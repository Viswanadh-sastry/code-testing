...
const channelsColumns: ReadonlyArray<Column<Channels>> = [
  ...
  {
    Header: (props) => <ChannelsCustomHeader tableProps={props} title="Connected?" className="min-w-50px" />,
  ...
  {
    Header: (props) => <ChannelsCustomHeader tableProps={props} title="Located?" className="min-w-50px" />,
    accessor: "isLocated",
    Cell: ({ value }) =>
      value ? (
        <center>
