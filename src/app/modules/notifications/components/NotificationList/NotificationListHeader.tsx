...
import { deleteNotificationById } from "../../api/NotificationAPI";
...
const NotificationListHeader = ({ setFilterNotification, notificationListQuery }: INotificationListHeaderProps) => {
