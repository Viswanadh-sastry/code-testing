...
const UsersTable = () => {
  ...
  return (
    <KTCard>
      <UsersListHeader onShowAddUser={onShowAddUser} setFilterUser={setFilterUser} onShowImportUser={onShowImportUser} filterUser={filterUser} />
      <KTCardBody className="py-4">
        ...
        <UsersListPagination filterUser={filterUser} setFilterUser={setFilterUser} />
