...
const EditView = ({ inputData, onClose, onEditView }: IEditViewProps) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      devices: inputData.devices as [],
      timeline: inputData.timeline as number,
        ...
        <div className="modal-dialog modal-dialog-centered mw-900px">
          ...
          <div className="modal-content">
            <div className="modal-header d-flex justify-content-between align-items-center">
              {/* begin::Modal title */}
              <h2 className="fw-bolder">Edit Widget</h2>
              {/* end::Modal title */}
              ...
              <form id="kt_modal_create_view_form" className="form" onSubmit={formik.handleSubmit} noValidate>
                ...
                <div className="d-flex flex-column me-n7 pe-7">
                        ...
                        <div className="flex-row mb-6">
                          <label className="m-2 cursor-pointer">
                            <input
                              ...
                              defaultChecked={String(formik.values.timeline) === "30"}
                            />
                          ...
                          <label className="m-2 cursor-pointer">
                            <input
                              ...
                              value={90}
                              className="form-check-input"
                              defaultChecked={String(formik.values.timeline) === "90"}
                            />
                          ...
                          <label className="m-2 cursor-pointer">
                            <input
                              ...
                              value={180}
                              className="form-check-input"
                              defaultChecked={String(formik.values.timeline) === "180"}
                            />
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="fv-row mb-6">
                        <label className="fw-bold fs-6 mb-2">Layout: {inputData?.layout}</label>
