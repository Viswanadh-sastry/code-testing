...
interface IDashboardListPaginationProps {
  filterDashboard: any;
...
const DashboardListPagination = ({ filterDashboard, setFilterDashboard }: IDashboardListPaginationProps) => {
  ...
  useEffect(() => {
    if (dashboardListQuery.data) {
      const noOfLinks = dashboardListQuery.data.total;
      // const noOfPages = Math.ceil(noOfLinks / dashboardListQuery.data.limit);
      const noOfPages = Math.ceil(noOfLinks / filterDashboard.limit);
      const links = [];
  ...
  return (
    <div className="row">
      <div className="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
        ...
        <div id="kt_table_dashboard_info" className="dataTables_info">
          {isLoading ? "Loading..." : `Total ${dashboardListQuery.data?.total || 0} dashboards`}
        </div>
      </div>
      <div className="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
        <div id="kt_table_dashboard_paginate">
...
export { DashboardListPagination };
