...
const GroupListHeader = ({ setFilterGroup }: IGroupsListHeaderProps) => {
  ...
  const openMessagingPage = () => {
    navigate("/history/group/list", { state: { selectedValues } });
  };
            ...
            <>
              <div className="text-start">
                <span className="text-muted fw-bold mx-6">
                  <b> {selectedValues.length}</b> assets group selected
                </span>
              </div>
