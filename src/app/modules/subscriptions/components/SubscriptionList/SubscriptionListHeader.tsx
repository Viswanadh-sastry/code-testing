...
const SubscriptionListHeader = ({ onShowAddSubscription, subscriptionListQuery }: ISubscriptionListHeaderProps) => {
  ...
  const downloadCSV = async () => {
    ...
    // const headerOrder = ["id", "name", "description", "categories", "labels", "receiver", "channels", "resendInterval", "resendLimit", "created_at"];
  ...
  const downloadPDF = async () => {
    ...
    //   3: { cellWidth: 50 }, // Categories
    //   4: { cellWidth: 50 }, // Labels
    //   5: { cellWidth: 50 }, // Receiver
    //   6: { cellWidth: 50 }, // Channels
    //   7: { cellWidth: 50 }, // Resend Interval
    //   8: { cellWidth: 50 }, // Resend Limit
    //   9: { cellWidth: 50 }, // Created At
    // };
