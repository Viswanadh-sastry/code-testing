...
import { createGroupUser, getAddUsersList } from "../../../api/GroupUserAPI";
...
const AddUser = ({ onCloseAddUser, onGetUserList }: IAddUserProps) => {
  ...
  const { id: domainId } = getDomain();
  const [rolePermission, setRolePermission] = useState<any>(null);

  useEffect(() => {
    const fetchRolePermission = async () => {
      const permission = await getRolePermission(MODULENAME.ASSETGROUPMEMBER, groupId);
  ...
  const userListQuery = useQuery({
    ...
    queryFn: async () => getAddUsersList(domainId, filterUser).catch((error) => toast.error(error.message)),
    enabled: true,
  });
  ...
  const UserSchema = Yup.object().shape({
    ...
    user_ids: Yup.string().required("Member is required."),
  });
        ...
        <div className="modal-dialog modal-dialog-centered mw-900px">
          ...
          <div className="modal-content">
            <div className="modal-header d-flex justify-content-between align-items-center">
              {/* begin::Modal title */}
              <h2 className="fw-bolder">Add Member</h2>
              {/* end::Modal title */}
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="fv-row mb-6">
                        <label className="fw-bold fs-6 mb-2">Member Name</label>

                        <input type="text" name="searchUser" value={filterUser.name} placeholder="Search Member" className="form-control mb-3" onChange={onChangeUser} />
                    ...
                    <div className="col-md-12">
                      <div className="fv-row mb-6">
                        ...
                        >
                          ...
                          {rolePermission?.admin && <option value="administrator">administrator</option>}
                          {(rolePermission?.admin || rolePermission?.editor) && <option value="editor">editor</option>}
