...
const DisplayUserData = () => {
  ...
  const groupUser = groupUserQuery.data;
        ...
        <Table responsive bordered>
          <tbody>
            ...
            <tr>
              ...
              <td>
                {!groupUser?.metadata || typeof groupUser?.metadata !== "object" ? (
                  <span className="text-muted"></span>
                ) : (
                  <div>
                    {Object.entries(groupUser?.metadata).map(([key, val], index) => (
