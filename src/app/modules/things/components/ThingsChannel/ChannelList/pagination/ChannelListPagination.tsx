...
interface IChannelListPaginationProps {
  filterChannel: any;
...
const ChannelListPagination = ({ filterChannel, setFilterChannel }: IChannelListPaginationProps) => {
  ...
  return (
    <div className="row">
      <div className="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
        ...
        <div id="kt_table_channel_info" className="dataTables_info">
          {isLoading ? "Loading..." : `Total ${channelListQuery.data?.total || 0} assets`}
        </div>
      </div>
      <div className="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
        <div id="kt_table_channel_paginate">
