...
import { InviteUserByDomain } from "../InviteUserByDomain/InviteUserByDomain";
import { DomainInvitationsListHeader } from "./DomainInvitationsListHeader";
...
const DomainInvitationsTable = () => {
  ...
  return (
    <KTCard>
      <DomainInvitationsListHeader onShowInviteUser={onShowInviteUser} setFilterInvitation={setFilterInvitation} />
      <KTCardBody className="py-4">
        ...
        {showInviteUser && <InviteUserByDomain onCloseInviteUser={onCloseInviteUser} onGetInvitationList={onGetInvitationList} />}
